...
public class ProfileUseCases {
    ...
    /**
     * Creates a profile gateway class with the option of being in memory or to save to the database file.
     *
     * @param inMemory whether the database is in-memory or not.
     */
    public ProfileUseCases(boolean inMemory) {
        if (inMemory){
    ...
    public boolean createNewPerson(
        ...
        return this.profileGateway.addProfileData(accountUsername, person);
    }
    ...
    public boolean createNewOrganization(String accountUsername, String name, String phone, String email) {
        ...
        return this.profileGateway.addProfileData(accountUsername, org);
    }
